...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(650, 155, 111, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_0.setText(_translate("MainWindow", "Добавление тура"))
        self.label_0.setFont(QFont('Arial', 14))

        self.label_8.setText(_translate("MainWindow", "Удаление тура"))
