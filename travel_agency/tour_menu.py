...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Окно Туры"))
        self.pushButton.setText(_translate("MainWindow", "Туры"))
        self.pushButton_2.setText(_translate("MainWindow", "Тур клиента"))
